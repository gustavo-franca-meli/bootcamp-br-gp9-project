...
INSERT INTO `sellers` (`name`) VALUES ('Carolina Fugita');
INSERT INTO `sellers` (`name`) VALUES ('Gustavo França');
INSERT INTO `sellers` (`name`) VALUES ('Leonardo Carias');
INSERT INTO `sellers` (`name`) VALUES ('Nycolas Vieira');