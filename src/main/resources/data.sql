...
INSERT INTO product (description, name, price, seller_id)
VALUES ( "A bisteca é uma carne suína muito saborosa e que pode ser preparada na panela de pressão, assada e muito mais. Alguns ingredientes proporcionam um sabor ainda mais especial a essa carne como o mel, maçã e sucos de frutas cítricas.", "Bisteca Suína", 13.89, 1);
INSERT INTO product (description, name, price, seller_id)
VALUES ( "A batata é um alimento muito versátil e pode ser preparado de diferentes maneiras como assada, cozida, frita ou até mesmo recheada. Além disso, a batata é repleta de vitamina e também do Complexo B.", "Batata Lavada 1 Unidade 300g", 0.90, 2);
...
INSERT INTO warehouse (name, country_id, representative_id) VALUES ("Centro de Tratamento - Cuiabá", 5, 2);
INSERT INTO warehouse (name, country_id, representative_id) VALUES ("Centro de Tratamento - Medelin", 4, 1);
...
INSERT INTO batch (`id`, `current_quantity`, `current_temperature`, `due_date`, `initial_quantity`, `manufacturing_date`, `manufacturing_time`, `minimum_temperature`, `inbound_order_id`, `product_id`, `sector_id`) VALUES (3, 40, 20.0, '2021-07-30', 100, '2021-04-10', '2021-04-10', 10.0, null, 1,1);
INSERT INTO batch (`id`, `current_quantity`, `current_temperature`, `due_date`, `initial_quantity`, `manufacturing_date`, `manufacturing_time`, `minimum_temperature`, `inbound_order_id`, `product_id`, `sector_id`) VALUES (4, 150, 20.0, '2021-12-08', 100, '2021-04-10', '2021-04-10', 10.0, null, 2,2);
INSERT INTO batch (`id`, `current_quantity`, `current_temperature`, `due_date`, `initial_quantity`, `manufacturing_date`, `manufacturing_time`, `minimum_temperature`, `inbound_order_id`, `product_id`, `sector_id`) VALUES (5, 10, 20.0, '2021-08-08', 100, '2021-04-10', '2021-04-10', 10.0, null, 1,2);



INSERT INTO sector_types (`sector_id`,`types`) VALUES (1,1);
INSERT INTO sector_types (`sector_id`,`types`) VALUES (2,3);

INSERT INTO sector_product_types (`product_id`,`types`) VALUES (1,3);
INSERT INTO sector_product_types (`product_id`,`types`) VALUES (2,1);