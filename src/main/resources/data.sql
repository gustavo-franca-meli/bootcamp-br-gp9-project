...
INSERT INTO representative (name,account_id,warehouse_id) VALUES ('Carol Fugita', 5 , null);

INSERT INTO warehouse (name, country_id, representative_id) VALUES ("Centro de Tratamento - Verdão", 5, 1);

UPDATE representative SET warehouse_id = 1 WHERE (`id` = 1);

INSERT INTO sector (`max_quantity_batches`, `warehouse_id`) VALUES ('50', 1);

INSERT INTO sector (`max_quantity_batches`, `warehouse_id`) VALUES ('1', 1);
...
SELECT product.name, sum(current_quantity) from product, batch
where batch.product_id = product.id AND product_id = 1
